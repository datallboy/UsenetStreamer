/**
 * @param {Object} deps
 * @returns {(req: import('../../types').NzbdavStreamHandlerRequest, res: import('../../types').NzbdavStreamHandlerResponse) => Promise<void>}
 */
function createNzbdavStreamHandler(deps) {
  const {
    decodeStreamParams,
    ...
    setPrefetchedNzbdavJob,
  } = deps;

  return async function handleNzbdavStream(req, res) {
    ...
    try {
      ...
      if (prefetchedSlotHint?.nzoId) {
        setPrefetchedNzbdavJob(downloadUrl, {
          ...prefetchedSlotHint,
