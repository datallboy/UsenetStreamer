/**
 * @param {Object} deps
 * @returns {(req: import('../../types').EasynewsNzbHandlerRequest, res: import('../../types').EasynewsNzbHandlerResponse) => Promise<void>}
 */
function createEasynewsNzbHandler(deps) {
  const { easynewsService, getStreamingMode } = deps;
