...
adminApiRouter.post('/test-connections', createAdminConnectionTestHandler({
  testIndexerConnection,
  testNzbdavConnection,
  testUsenetConnection,
  testNewznabConnection,
...
const nzbdavStreamHandler = createNzbdavStreamHandler({
  decodeStreamParams,
  ...
  setPrefetchedNzbdavJob: (downloadUrl, value) => {
    prefetchedNzbdavJobs.set(downloadUrl, value);
  },
});
